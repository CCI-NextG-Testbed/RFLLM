...
# CONFIG
# -------------------------
PDF_PATH = "Phase_Shift_QuKeying.pdf"  # change to your file
BOOK_ID = "Xiong"
BOOK_TITLE = "Digital_Communications"
CHAPTER_TITLE = "Phase_Shift_Keying"

CHUNK_SIZE_WORDS = 200   # ~ chunk length
CHUNK_OVERLAP_WORDS = 75

OUTPUT_JSON = "PHASE_SHIFT_KEYING.json"
